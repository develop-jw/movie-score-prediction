...
또한, 단순 모델 실험에서 끝내지 않고, 데이터 분석 결과가 실제 서비스로 이어지는 전체 흐름을 직접 경험해보고자 시작한 프로젝트입니다.  
...
| 모델 | 방식 | 비선형 | 서빙 난이도 |
|------|------|--------|------------|
| Matrix Factorization | 선형 내적 | ❌ | 쉬움 |
| **NCF** | MLP + GMF | ✅ | **쉬움** |
| Two-Tower | 별도 인코더 | ✅ | 중간 |
| Transformer 기반 | Attention | ✅ | 어려움 |
